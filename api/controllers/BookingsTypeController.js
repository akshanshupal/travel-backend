module.exports = {
    ...
    find: async function (req, res) {
        ...
        try {
            var records = await BookingsTypeService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await BookingsTypeService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await BookingsTypeService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    deleteOne: async function (req, res) {
        ...
        try {
            var record = await BookingsTypeService.deleteOne(req, req.params.id);
        } catch (error) {
            return res.serverError(error);
        }
