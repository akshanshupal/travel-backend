module.exports = {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await PackageService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await PackageService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await PackageService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    deleteOne: async function (req, res) {
        ...
        try {
            var record = await PackageService.deleteOne(req, req.params.id);
        } catch (error) {
            return res.serverError(error);
        }
