module.exports = {
    ...
    find: async function (req, res) {
        ...
        if (req.session && req.session.activeCompany) {
        ...
        try {
            var records = await PackageVoucherService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await PackageVoucherService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await PackageVoucherService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await PackageVoucherService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    deleteOne: async function (req, res) {
        ...
        try {
            var record = await PackageVoucherService.deleteOne(req, req.params.id);
        } catch (error) {
            return res.serverError(error);
        }
