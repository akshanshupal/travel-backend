module.exports = {
    ...
    find: async function (req, res) {
        ...
        try {
            var records = await HotelCategoryService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await HotelCategoryService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await HotelCategoryService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await HotelCategoryService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    deleteOne: async function (req, res) {
        ...
        try {
            var record = await HotelCategoryService.deleteOne(req, req.params.id);
        } catch (error) {
            return res.serverError(error);
        }
