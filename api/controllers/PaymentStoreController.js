module.exports = {
    ...
    find: async function (req, res) {
        ...
        try {
            var records = await PaymentStoreService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await PaymentStoreService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await PaymentStoreService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
