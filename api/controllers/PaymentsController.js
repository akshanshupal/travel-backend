module.exports = {
    ...
    find: async function (req, res) {
        ...
        try {
            var records = await PaymentsService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await PaymentsService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await PaymentsService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await PaymentsService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
