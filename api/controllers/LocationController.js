module.exports = {
    ...
    find: async function (req, res) {
        ...
        try {
            var records = await LocationService.find(req, filter, params);
        } catch (error) {
    ...
    findOne: async function (req, res) {
        ...
        try {
            var record = await LocationService.findOne(req, req.params.id,params);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    create: async function (req, res) {
        ...
        try {
            var record = await LocationService.create(req, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    updateOne: async function (req, res) {
        ...
        try {
            var record = await LocationService.updateOne(req, req.params.id, req.body);
        } catch (error) {
            return res.serverError(error);
        }
    ...
    deleteOne: async function (req, res) {
        ...
        try {
            var record = await LocationService.deleteOne(req, req.params.id);
        } catch (error) {
            return res.serverError(error);
        }
