# @newari/sails-generate-api-service-generator

A `api-service-generator` generator for use with the Sails command-line interface.


## Installation

```sh
$ npm install @newari/sails-generate-api-service-generator --save
```
...
{
  "modules": {
    "api-service-generator": "@newari/sails-generate-api-service-generator"
  }
}
```

> Note that instead of `"@newari/sails-generate-api-service-generator"`, you can also choose to provide the path to the generator locally (e.g. "./generators/api-service-generator").
...
## Bugs &nbsp; [![NPM version](https://badge.fury.io/js/@newari/sails-generate-api-service-generator.svg)](http://npmjs.com/package/@newari/sails-generate-api-service-generator)
...
[![NPM](https://nodei.co/npm/@newari/sails-generate-api-service-generator.png?downloads=true)](http://npmjs.com/package/@newari/sails-generate-api-service-generator)



## License

This api-service-generator generator is available under the **MIT license**.
